	...
	<form action="inputCheck" method="post" >
		...
		<table>
			...
			<tr>
				...
				<td>
					<input type="text" name="mail" placeholder="メールアドレス" required="required" value="${ stfMail }"
						maxlength="100"
					/>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="password" name="pass" placeholder="パスワード" required="required" value="${ stfPass }"
